...
s32 main() {
    ...
    base_string str = fsys.file_read("Makefile");
    u32   file_size = (u32)fsys.file_size("Makefile");

    std::cout << str.c_str() << std::endl << file_size << std::endl << str.size() << std::endl;
    ...
    std::cout << fsys.file_read("test_gs.txt").c_str() << std::endl;
